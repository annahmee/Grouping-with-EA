...
def begin(n=4, x=2, n_groups=50, teachers=4, accuracy_level=2, clash_teacher=[], same_teacher=[], rd=0.5, alpha=0.9, save = 0.8,no_dabian=[],filedir=r'./algorithm/input_data/',filename='file.xlsx'):
    ...
    plt.savefig(r'./algorithm/DE/figure/global_distribution.png')
...
# 564-611
    ...
    #tools.plot_fun.plot_scale(g_best, "DE", id_score)
    # 将结果写到csv
    grouping.algorithm.tools.resultToCSV.to_CSV(g_best, "DE", id_score, id_teacher,id_name,id_theme)
    # 画出迭代过程中多样性的图
...
if __name__ == '__main__':
    a,b,c = begin(n=4, accuracy_level=2, teachers=4,alpha=0.8,filename='2020_data.xlsx')
    print(b[-1])
    print(b)
# 一次结果
